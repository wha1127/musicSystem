        ...
        <div className="Drawer">
          ...
          <div>
            ...
            <div className="DrawerBody">
              定时关闭
              <Switch
                checked={this.state.en1}
                onChange={this.changeLanguage1}
              />
            </div>
            <div className="DrawerBody">免流量服务</div>
            <div className="DrawerBody">微云音乐网盘</div>
            <div className="DrawerBody">传歌到手机</div>
            <div className="DrawerBody">QPlay与车载音乐</div>
            <div className="DrawerBody">清理占用空间</div>
            <div className="DrawerBody">免费WIFI</div>
            <div className="DrawerBody">帮助与反馈</div>
            <div className="DrawerBody">关于QQ音乐</div>
          </div>
